...
export type WalletNativeCoin = Pick<Token, 'balance' | 'decimals' | 'logoURI' | 'name' | 'symbol'>
...
export class WalletService extends BaseStore<WalletData, WalletState> {
    ...
    public get coin(): WalletNativeCoin {
        return {
            ...
            decimals: this.nativeCoin!.decimals,
            logoURI: this.nativeCoin!.logoURI,
            name: this.nativeCoin!.name,
            symbol: this.nativeCoin!.symbol,
        }
    }
